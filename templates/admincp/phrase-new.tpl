...
<div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-user"></i> Phrases <i class="fa fa-hand-o-right"></i> <i class="fa fa-settings"></i> 
                            </li>
                        </ol>
                    </div>
                </div>
                       ...
                       <div class="col-lg-12">
                        ...
                        <form enctype="multipart/form-data" class="admin_form" data-parsley-validate method="post" enctype="multipart/form-data" action="{$config.url}/admincp/language/save_phrase">  
                                 ...
                                 <div class="col-lg-12">
                                  ...
                                  <div class="row">                            
                                       <div class="col-lg-12">
                                        <div class="col-lg-4"><input type="text" value="" class="form-control"  name="phrase_name" /></div>
