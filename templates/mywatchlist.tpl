           ...
           {else}
              {foreach $mywatchlist as $key => $val}
                <div class="row mblue_box1">
                  ...
                  <div class="col-md-2"><a href="{$config.url}/dashboard/watchlist/{$val.id}" class="" title="Delete"><i class="fa fa-trash"></i></a></div>
                </div>
              {/foreach}
              {if $pagination_html != '<div class="paginator"></div>'}
               <div class="row mblue_box1">
                  <div class="col-md-12">
                    {$pagination_html}
                  </div>
